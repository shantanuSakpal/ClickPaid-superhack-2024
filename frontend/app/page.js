...
export default function Home() {
    return (<main className="flex  flex-col items-center justify-between ">
            ...
            <div className="flex justify-center items-center w-full py-8 px-2 gap-5">
                <div className="w-1/2 px-10 gap-3 flex flex-col">
                    <h1 className="text-6xl font-bold text-theme-gray-dark">Create. Vote. Earn.</h1>
                    <p className="text-2xl text-justify">Upload or Create amazing thumbnails using <strong
                        className="text-theme-blue">AI</strong>, and let the <strong
                        className="text-theme-blue">Community</strong> choose the best one! <br/>

                    </p>
                    <button
                        className="mt-5 bg-theme-blue-light hover:bg-theme-blue   font-bold text-xl  rounded-full py-2 flex flex-row items-center justify-center text-white">
	...
	c-1.4,10.9-4.7,21.1-9.5,30.5H223.6z"/>
                        ...
                        <span>Login to get started</span></button>
        ...
        {/*features*/}
        <div className="flex justify-center  w-full my-12 p-10 gap-10 text-center">
            <div className="w-1/3">
                <div className="icon">

                </div>
                <h2 className="text-2xl font-extrabold text-theme-blue-light">Empowering Creators,<br/> One Thumbnail at
                    a
                    Time</h2>
                ...
                <div className="w-1/3">
                    ...
                    <h2 className="text-2xl font-extrabold text-theme-blue-light">Rewarding Your Influence,<br/>One Vote at
                        a Time</h2>
                    <p className="mt-1 mb-5 text-lg">Earn rewards for Shaping the Content Landscape and Deciding What
                        Gets Seen</p>
                    <Link href="/create"
                          className="px-5 py-2 text-white rounded-full text-lg font-bold hover:bg-theme-blue bg-theme-blue-light mt-4">
                        See your rewards!
